...
```bash
python docs/demos/mockups/scripts/mock_mqtt_publisher.py --devices 3 --loops 20
```
...
```bash
PYTHONPATH=backend python docs/demos/mockups/scripts/mock_fl_clients.py --clients 3 --rounds 3
```
...
```bash
python docs/demos/mockups/scripts/mock_mqtt_publisher.py --help
```

- gRPC host/port i dimensió model:

```bash
PYTHONPATH=backend python docs/demos/mockups/scripts/mock_fl_clients.py --help
```
