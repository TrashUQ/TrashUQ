...
|---:|---:|---:|---:|---:|---:|---:|---|
| 2 | `93.75 +- 0.57%` | `0.2184 +- 0.0247` | `94.89%` | `1.33` | `-0.000` | `0.33` | `95% CI acc [92.34, 95.16]%` |
| 5 | `93.75 +- 0.57%` | `0.2007 +- 0.0059` | `94.32%` | `1.00` | `0.019` | `0.33` | `95% CI acc [92.34, 95.16]%` |
| 10 | `93.37 +- 1.18%` | `0.2021 +- 0.0194` | `94.51%` | `1.00` | `-0.038` | `0.00` | `95% CI acc [90.43, 96.31]%` |
| 20 | `93.75 +- 0.57%` | `0.1935 +- 0.0129` | `94.89%` | `1.00` | `-0.095` | `0.33` | `95% CI acc [92.34, 95.16]%` |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 2 | `0.002` | `0.001` | `4.00` | `100.00` | `0.1968` | `0.0505` | `3.79` | `Stable convergence under Dirichlet non-IID partitioning.` |
| 5 | `0.003` | `0.001` | `10.00` | `250.00` | `0.4921` | `0.1264` | `1.52` | `Stable convergence under Dirichlet non-IID partitioning.` |
| 10 | `0.003` | `0.001` | `20.00` | `500.00` | `0.9842` | `0.2527` | `0.75` | `Stable convergence under Dirichlet non-IID partitioning.` |
| 20 | `0.005` | `0.002` | `40.00` | `1000.00` | `1.9684` | `0.5054` | `0.38` | `Stable convergence under Dirichlet non-IID partitioning.` |
...
|---|---|---:|---:|---|---|
| 2 vs 5 clients | `Exact permutation` | `1.0000` | `0.000` | `NO` | `Final accuracy comparison with n=3 per setting.` |
| 5 vs 10 clients | `Exact permutation` | `0.9000` | `0.408` | `NO` | `Final accuracy comparison with n=3 per setting.` |
| 10 vs 20 clients | `Exact permutation` | `0.9000` | `-0.408` | `NO` | `Final accuracy comparison with n=3 per setting.` |

## Required Figures
1. Accuracy vs rounds for each client count: `artifacts/part_b/quant_8bit/figures/figure_1_accuracy_vs_rounds.png`
2. Loss vs rounds for each client count: `artifacts/part_b/quant_8bit/figures/figure_2_loss_vs_rounds.png`
3. Mean round time vs clients: `artifacts/part_b/quant_8bit/figures/figure_3_round_time_vs_clients.png`
4. Communication cost (MB) vs clients: `artifacts/part_b/quant_8bit/figures/figure_4_comm_cost_vs_clients.png`
5. Accuracy vs communication cost (tradeoff scatter): `artifacts/part_b/quant_8bit/figures/figure_5_accuracy_vs_comm.png`

## Ready-To-Use Results Text
"Across 2/5/10/20 simulated clients under non-IID partitions (Dirichlet alpha=0.3), FedAvg reached a final accuracy of 93.75/93.75/93.37/93.75 for 2/5/10/20 clients, respectively. Convergence speed decreased with client count, with mean round duration increasing from 0.002s to 0.005s. Communication overhead scaled from 0.2474 MB to 2.4738 MB, yielding an accuracy-per-MB tradeoff of 3.79 to 0.38. Despite higher heterogeneity and communication cost, all settings maintained stable training with 100.0% successful round aggregation."
...
```text
COMPLETED run_001 clients=2 seed=11 rounds=25/25 final_acc=93.75% final_loss=0.2246 total_time=0.06s
COMPLETED run_002 clients=2 seed=29 rounds=25/25 final_acc=94.32% final_loss=0.1912 total_time=0.06s
COMPLETED run_003 clients=2 seed=47 rounds=25/25 final_acc=93.18% final_loss=0.2393 total_time=0.06s
COMPLETED run_004 clients=5 seed=11 rounds=25/25 final_acc=93.18% final_loss=0.1988 total_time=0.06s
COMPLETED run_005 clients=5 seed=29 rounds=25/25 final_acc=93.75% final_loss=0.1960 total_time=0.06s
COMPLETED run_006 clients=5 seed=47 rounds=25/25 final_acc=94.32% final_loss=0.2074 total_time=0.06s
COMPLETED run_007 clients=10 seed=11 rounds=25/25 final_acc=92.05% final_loss=0.2241 total_time=0.08s
COMPLETED run_008 clients=10 seed=29 rounds=25/25 final_acc=94.32% final_loss=0.1875 total_time=0.08s
COMPLETED run_009 clients=10 seed=47 rounds=25/25 final_acc=93.75% final_loss=0.1947 total_time=0.08s
COMPLETED run_010 clients=20 seed=11 rounds=25/25 final_acc=94.32% final_loss=0.1798 total_time=0.15s
COMPLETED run_011 clients=20 seed=29 rounds=25/25 final_acc=93.75% final_loss=0.1952 total_time=0.10s
COMPLETED run_012 clients=20 seed=47 rounds=25/25 final_acc=93.18% final_loss=0.2055 total_time=0.10s

# 2 clients :: runs/run_001/round_metrics.csv
round,global_accuracy,global_loss,round_duration_s,participating_clients
1,0.9375,0.2202,0.0026,2
2,0.9432,0.2066,0.0021,2
3,0.9489,0.2012,0.0021,2
# 5 clients :: runs/run_004/round_metrics.csv
round,global_accuracy,global_loss,round_duration_s,participating_clients
1,0.9148,0.3089,0.0028,5
2,0.9261,0.2613,0.0026,5
3,0.8864,0.2658,0.0025,5
# 10 clients :: runs/run_007/round_metrics.csv
round,global_accuracy,global_loss,round_duration_s,participating_clients
1,0.9205,0.4024,0.0032,10
2,0.9148,0.2992,0.0030,10
3,0.9261,0.2731,0.0030,10
# 20 clients :: runs/run_010/round_metrics.csv
round,global_accuracy,global_loss,round_duration_s,participating_clients
1,0.9205,0.4359,0.0042,20
2,0.9375,0.3428,0.0071,20
3,0.9375,0.3009,0.0075,20
